...
\begin{wrapfigure}[4]{l}{0.45\linewidth}
...
\begin{itemize}
  ...
  \item \textbf{\Rtrace{} is a foundation for building semantic-based developer tools.}
...
The source code and test suite for the \Rtrace{} interpreter and visualizer are available on GitHub at \href{https://github.com/Zeta611/react-trace}{\gh{Zeta611/react-trace}}, archived on Zenodo \citep{LeeAhn25Zenodo}, and hosted online at \href{https://react-trace.vercel.app/}{\nolinkurl{react-trace.vercel.app}}.

This work was published under the same title at OOPSLA~2025 \citep{LeeAhnYi25React}.
